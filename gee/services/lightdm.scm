...
(define-module (gee services lightdm)
  ...
  #:export (lightdm-seat-configuration
            ...
            slick-greeter-configuration?
            slick-greeter-configuration-slick-greeter
            slick-greeter-configuration-assets
            slick-greeter-configuration-extra-config
...
(define-configuration slick-greeter-configuration
  (slick-greeter
   (file-like slick-greeter)
   "The slick-greeter package to use."
   empty-serializer)
  (assets
   (list-of-file-likes (list adwaita-icon-theme
                             gnome-themes-extra
...
(define (greeter-configuration->greeter-fields config)
  ...
  (match config
    ...
    ((? slick-greeter-configuration?)
     slick-greeter-configuration-fields)))
...
greeter configuration."
  (match config
    ...
    ((? slick-greeter-configuration?)
     (cons (slick-greeter-configuration-slick-greeter config)
           (slick-greeter-configuration-assets config)))))
...
(define (greeter-session? value)
  (memq value '(lightdm-gtk-greeter slick-greeter)))
...
(define (greeter-configuration? config)
  (or (lightdm-gtk-greeter-configuration? config)
      (slick-greeter-configuration? config)
      ;; Note: register any new greeter configuration here.
      ))
...
(define (generate-doc)
  ...
  (configuration->documentation 'slick-greeter-configuration)
