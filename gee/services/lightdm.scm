...
(define-module (gee services lightdm)
  ...
  #:export (lightdm-seat-configuration
            ...
            lightdm-slick-greeter-configuration?
            lightdm-slick-greeter-configuration-lightdm-slick-greeter
            lightdm-slick-greeter-configuration-assets
            lightdm-slick-greeter-configuration-extra-config
...
(define-configuration lightdm-slick-greeter-configuration
  (lightdm-slick-greeter
   (file-like lightdm-slick-greeter)
   "The lightdm-slick-greeter package to use."
   empty-serializer)
  (assets
   (list-of-file-likes (list adwaita-icon-theme
                             gnome-themes-extra
...
icon themes."
  ...
  (extra-config
   (list-of-strings '())
   "Extra configuration values to append to the LightDM SLICK Greeter
configuration file."))
...
(define (greeter-configuration->greeter-fields config)
  ...
  (match config
    ...
    ((? lightdm-slick-greeter-configuration?)
     lightdm-slick-greeter-configuration-fields)))
...
greeter configuration."
  (match config
    ...
    ((? lightdm-slick-greeter-configuration?)
     (cons (lightdm-slick-greeter-configuration-lightdm-slick-greeter config)
           (lightdm-slick-greeter-configuration-assets config)))))
...
(define (greeter-session? value)
  (memq value '(lightdm-gtk-greeter lightdm-slick-greeter)))
...
(define (greeter-configuration? config)
  (or (lightdm-gtk-greeter-configuration? config)
      (lightdm-slick-greeter-configuration? config)
      ;; Note: register any new greeter configuration here.
      ))
...
(define (generate-doc)
  ...
  (configuration->documentation 'lightdm-slick-greeter-configuration)
