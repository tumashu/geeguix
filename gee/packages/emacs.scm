...
(define-public emacs-gee
  (let ((commit "4e0f4292aaf1a9bf26ba2ee2983955cefc50beea")
        (revision "1"))
    (package
      (inherit emacs)
      (name "emacs-gee")
      (version (git-version "29.0.90" revision commit))
      (source
       (origin
         ...
         (sha256
          (base32
           "1l0y7xsl17sbz0667cxddsbm8l2f8mdnxd3625az870jvkvs01ml"))))
      (inputs
...
(define-public emacs-helper
  (let ((commit "3a7892a2daef097ab02517dfd8240cd552495596")
        (revision "5"))
    (package
      ...
      (source
       (origin
         ...
         (method git-fetch)
         (sha256
          (base32 "1h1bkckri97r91b926ck5k3pzr02kpksrkxbpza8d0bkk9ly7imj"))
         (file-name (git-file-name name version))))
